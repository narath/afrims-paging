...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Group.is_personal_group'
        db.add_column('groups_group', 'is_personal_group', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Group.is_personal_group'
        db.delete_column('groups_group', 'is_personal_group')
    ...
    models = {
        'groups.group': {
            ...
            'is_personal_group': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
        ...
        'rapidsms.contact': {
            ...
            'department': ('django.db.models.fields.CharField', [], {'max_length': '32', 'blank': 'True'}),

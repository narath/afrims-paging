...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('rapidsms_contact', 'department', self.gf('django.db.models.fields.CharField')(default='', max_length=32, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Contact.department'
        db.delete_column('rapidsms_contact', 'department')
